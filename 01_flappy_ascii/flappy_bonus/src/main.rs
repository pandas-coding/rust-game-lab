...
fn main() -> BError {
    let context = BTermBuilder::new()
        .with_font("../assets/flappy32.png", 32, 32)
        .with_simple_console(SCREEN_WIDTH, SCREEN_HEIGHT, "../assets/flappy32.png")
        .with_fancy_console(SCREEN_WIDTH, SCREEN_HEIGHT, "../assets/flappy32.png")
